...
export const DEFAULT_LANGUAGES = [{ name: "English", img: "/icons/eng.png", code: "en", newcode: "ENG" }, { name: "Русский", img: "/icons/du.png", code: "ru", newcode: "PУC" }, { name: "Українська", img: "/icons/ukr.png", code: "uk", newcode: "УKP" }]; //, { code: "de", name: "Deutsche", img: "/icons/ru.png" }
